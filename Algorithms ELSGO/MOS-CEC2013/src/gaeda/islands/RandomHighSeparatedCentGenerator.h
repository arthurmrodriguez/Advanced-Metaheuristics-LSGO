...
class RandomHighSeparatedCentGenerator : public RandomCentGenerator {
  ...
  double sumMinDistancesBetweenCentroids(vector<GAGenome*>& centroids) const;
  double findMinDistanceToOtherCentroids(vector<GAGenome*>& centroids, unsigned int pos) const;
public:
