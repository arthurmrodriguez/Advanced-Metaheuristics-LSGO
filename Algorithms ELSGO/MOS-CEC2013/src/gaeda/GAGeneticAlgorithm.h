...
class GAGeneticAlgorithm : public Algorithm {
   ...
   public:
      ...
      static GABoolean TerminateUponPopConvergenceDiscrete (GAGeneticAlgorithm&);

      static GABoolean TerminateUponPopConvergenceOrGen   (GAGeneticAlgorithm&);
      static GABoolean TerminateUponPopConvergenceOrEvals (GAGeneticAlgorithm&);
   ...
   public:
      ...
      double pConvergence () const;
      double pConvergence (double p);
      double pCrossover () const;
      double pCrossover (double p);
      double pMutation () const;
      double pMutation (double p);
      ...
      double convergence () const {return stats.convergence ();}
   ...
   protected:
      ...
      double           pconv;   ///< Convergence percentage
...
inline double GAGeneticAlgorithm::pConvergence () const {
...
inline double GAGeneticAlgorithm::pConvergence (double p) {
...
inline double GAGeneticAlgorithm::pCrossover () const {
...
inline double GAGeneticAlgorithm::pCrossover (double p) {
...
inline double GAGeneticAlgorithm::pMutation () const {
...
inline double GAGeneticAlgorithm::pMutation (double p) {
