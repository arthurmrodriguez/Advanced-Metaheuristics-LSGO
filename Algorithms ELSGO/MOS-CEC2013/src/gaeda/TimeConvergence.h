...
class TimeConvergence {
  static double       start_time__;
  static double       max_time__;
...
public:
  ...
  static void setInitTime   (double       init_time)    { start_time__    = init_time; assert(init_time >= 0); }
  static void setMaxTime    (double       max_time)     { max_time__     = max_time;  assert(max_time  >= 0); }
