...
class Objective {
  public:
    ...
    double objectiveFunction(VesicleInfo* info=NULL);
  ...
  protected:
    ...
    double edgeAvgIntensity;    // Average edge intensity
    double centerAvgIntensity;  // Average center intensity
    double edgeDeviation;       // Edge intensity deviation
    double centerDeviation;     // Center intensity deviation

    // Weight constants
    double kEdge, kCenter;
};
