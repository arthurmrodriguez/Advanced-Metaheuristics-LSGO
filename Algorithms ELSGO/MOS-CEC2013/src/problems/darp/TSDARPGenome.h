...
private:
  ...
  double evalWeightsUpdateValue_; // delta  in Cordeau's paper
  double lackOfDivPenalization_;  // lambda in Cordeau's paper
  double maxTabuLife_;            // teta   in Cordeau's paper
  ...
  double divPenalization(int newroute, int vertid);
