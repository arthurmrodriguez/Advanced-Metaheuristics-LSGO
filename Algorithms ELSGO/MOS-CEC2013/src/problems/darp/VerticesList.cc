...
double Vertex::maxRideValue__          = 0;
...
void Vertex::setTimeConstants(bool relativeTime, long relativeDelayConstant, double maxRideValue, long delay) {
...
long Vertex::maxRideTime(double distance) {
