...
public:
  ...
  virtual void setUpWithParams(vector<Vertex*>& vertices, int costv0v1, int costv1v2, int costv2v3, int costl1, int costl2,
      ...
      DARPEvaluator::darpOptCriterionType optcrit, bool computedeltimes, bool useconstrpen=true, bool usewaitingpen=false, long waitingPenThreshold=0, double waitingPenConstant=0) {
    dummydistmatrix = new DummyDistMatrix(MAXPOINTS);
  ...
  virtual double computeNewScore(vector<Vertex*>& vertices, int costv0v1, int costv1v2, int costv2v3, int costl1, int costl2,
      int vcapac, int sumtimeexp, int maxuserridetime, int maxpickuptime, int twv, int loadv, int ridev,
      DARPEvaluator::darpOptCriterionType optcrit, bool computedeltimes=true, bool useconstrpen=true, bool usewaitingpen=false, long waitingPenThreshold=0, double waitingPenConstant=0) {
    ...
    double new_score = (double) reqdistmatrix->reqSequenceScore(requests[0], requests[1], positions[1], positions[2], positions[3]);
  ...
  virtual void checkValues(Vertex* v0, Vertex* v1, Vertex* v2, Vertex* v3, int costv0v1, int costv1v2, int costv2v3, int costl1, int costl2,
    ...
    double new_score = computeNewScore(vertices,costv0v1, costv1v2, costv2v3, costl1, costl2, vcapac,sumtimeexp, maxuserridetime, maxpickuptime, twv, loadv, ridev, optcrit, computedeltimes);
  ...
  virtual void checkTimes(Vertex* v0, Vertex* v1, Vertex* v2, Vertex* v3, int costv0v1, int costv1v2, int costv2v3, int costl1, int costl2,
    ...
    for (int i=0; i<10000; i++) {
      double new_score = reqdistmatrix->reqSequenceScore(requests[0], requests[1], positions[1], positions[2], positions[3]);
    }
    ...
    double old_time = clock() - starttime;
...
TEST_F(ReqDistMatrixTesting2,testingWaitingPenalizationNoPen) {
  ...
  double withoutwaitpen = computeNewScore(vertices, costv0v1, costv1v2, costv2v3, costl1, costl2, vcapac,sumtimeexp,
                          maxuserridetime, maxpickuptime, twv, loadv, ridev, optcrit, false, false);

  double withwaitpen = computeNewScore(vertices, costv0v1, costv1v2, costv2v3, costl1, costl2, vcapac,sumtimeexp,
