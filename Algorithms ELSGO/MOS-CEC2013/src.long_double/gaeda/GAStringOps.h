...
extern "C" long double StringElementComparator (const GAGenome& g1, const GAGenome& g2) {return ElementComparator<char> (g1, g2);};
...
// Mutators
extern "C" int StringSwapMutator             (GAGenome& g, long double pmut) {return SwapMutator<char>             (g, pmut);}
extern "C" int StringFlipMutator             (GAGenome& g, long double pmut) {return FlipMutator<char>             (g, pmut);}
extern "C" int StringRepeatedExchangeMutator (GAGenome& g, long double pmut) {return RepeatedExchangeMutator<char> (g, pmut);}
extern "C" int StringSimpleInversionMutator  (GAGenome& g, long double pmut) {return SimpleInversionMutator<char>  (g, pmut);}
