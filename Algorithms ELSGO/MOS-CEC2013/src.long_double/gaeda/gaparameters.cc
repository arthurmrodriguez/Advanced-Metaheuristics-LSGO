...
namespace DefaultParameters {
	...
	long double convergencePerc		= 0.99;
	int   convergenceGens		=  30;
	long double mutationProb			= 0.01;
	long double crossoverProb			= 0.90;
	int   populationSize		= 50;
	int   nPopulations			= 10;
	long double replacementPerc		= 0.5;
	int   replacementNum		= 10;
	int   nOffsprings			= 2;
	long double migrationPerc			= 0.1;
	int   migrationNum			= 5;
	...
	/* GASimpleEDA */
	long double EDASelectionPerc		= 1.0;
