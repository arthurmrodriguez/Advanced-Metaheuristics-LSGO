...
namespace DefaultParameters {
   ...
   extern long double     convergencePerc;
   extern int       convergenceGens;
   extern long double     mutationProb;
   extern long double     crossoverProb;
   extern int       populationSize;
   extern int       nPopulations;
   extern long double     replacementPerc;
   ...
   /* GAIslandsGA */
   extern long double     migrationPerc;
   extern int       migrationNum;

   /* GASimpleEDA */
   extern long double    EDASelectionPerc;
