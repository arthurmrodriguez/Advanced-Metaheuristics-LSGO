...
// Comparators
extern "C" long double IntegerElementComparator (const GAGenome& g1, const GAGenome& g2) {return ElementComparator<int> (g1, g2);}
...
// DE Crossovers
extern "C" int IntegerExponentialCrossover (const GAGenome& p1, const GAGenome& p2, GAGenome* c1, const long double prob) {return ExponentialCrossover<int> (p1, p2, c1, prob);}
extern "C" int IntegerBinomialCrossover    (const GAGenome& p1, const GAGenome& p2, GAGenome* c1, const long double prob) {return BinomialCrossover<int>    (p1, p2, c1, prob);}

// Mutators
extern "C" int IntegerSwapMutator             (GAGenome& g, long double pmut) {return SwapMutator<int>             (g, pmut);}
extern "C" int IntegerFlipMutator             (GAGenome& g, long double pmut) {return FlipMutator<int>             (g, pmut);}
extern "C" int IntegerRepeatedExchangeMutator (GAGenome& g, long double pmut) {return RepeatedExchangeMutator<int> (g, pmut);}
extern "C" int IntegerSimpleInversionMutator  (GAGenome& g, long double pmut) {return SimpleInversionMutator<int>  (g, pmut);}
