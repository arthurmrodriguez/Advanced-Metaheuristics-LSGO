 ...
 */
void MOSTechniqueDE::offspring(MOSGenome& dad, MOSGenome& mom, GAPopulation* origPop, GAPopulation* destPop, unsigned size, unsigned offset) {
  ...
  std::vector<long double> scores (4, 0.0);
  scores[0] = dad.score();
  scores[1] = g1->score();
  scores[2] = g2->score();
  scores[3] = g3->score();
 ...
 */
void MOSTechniqueDE::offspring(GAPopulation* origPop, GAPopulation* destPop, unsigned size, unsigned offset) {
