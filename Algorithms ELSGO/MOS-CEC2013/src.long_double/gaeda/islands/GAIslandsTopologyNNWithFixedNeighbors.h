...
class GAIslandsTopologyNNWithFixedNeighbors : public GAIslandsTopologyNearestNeighbor {
  ...
  void         removeNeighborsUntilLimit     (vector< vector<long double> >& distance_matrix);
  unsigned int findFurthestNeighborMedoidPos (vector< vector<long double> >& distance_matrix );
