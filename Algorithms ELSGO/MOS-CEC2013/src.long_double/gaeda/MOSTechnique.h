...
class MOSTechnique : public GAID {
 ...
 public:
  ...
  long double getQuality(              ) const {if (!MOSTechnique::improvement_override) return _quality;
  ...
  long double   getRatioImproved(              ) const {return (long double) _times_improved / (long double) (1500.0 * _partRatio);}
