...
class MOSEA : public GAGeneticAlgorithm {
 ...
 public:
  ...
  MOSEA(const GAGenome& genome, const long double elitismPercent, const long double minPart, const evolutionType evolutiveApproach = CentralEvolution);
  MOSEA(const GAPopulation& population, const long double elitismPercent, const long double minPart, const evolutionType evolutiveApproach = CentralEvolution);
  MOSEA(const GAGeneticAlgorithm& alg, const long double elitismPercent, const long double minPart, const evolutionType evolutiveApproach = CentralEvolution);
  ...
  long double getMinParticipation(void) {return _minPart;}
 ...
 protected:
  ...
  std::map<techIdType,long double> computeDiversitiesAvg(GAPopulation* evalPop);
  ...
  // Attributes
  long double _bonus;                       // Coefficient to adapt the participation of each technique (in central approach only)
  ...
  long double _minPart;                     // Minimal participation for a technique
  long double _elitismPercent;              // The percent of the old Pop that are brought into the new Pop
