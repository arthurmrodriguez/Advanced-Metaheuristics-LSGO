...
typedef std::vector<GAGenome*> GACentroidVector;

/* FUNCTION PROTOTYPES */
GACentroidVector* GAgenerateCentroids (int number, long double minDist, GAGenome& sample, int maxiters, bool* success, long double* minfound);
