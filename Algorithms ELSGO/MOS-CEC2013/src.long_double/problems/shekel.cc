...
// Optimum genome for a 5-dimensional problem: [8.02491, 9.15172, 5.11392, 7.62086, 4.56408]

const float SHEK_MIN = 0;
const float SHEK_MAX = 10;

int global_size;

const long double shekel_a[30][10] = {
...
const long double shekel_c[] = {0.806, 0.517, 0.100, 0.908, 0.965, 0.669, 0.524, 0.902,
...
extern "C" GAGenome* defineProblem () {
   ...
   if (cfg->getProblemSize() > 10)
     throw runtime_error ("Error: the dimension cannot exceed 10 for Shekel problem.");

   global_size = cfg->getProblemSize();

   GAAlleleSet<long double> alleles (SHEK_MIN, SHEK_MAX);
