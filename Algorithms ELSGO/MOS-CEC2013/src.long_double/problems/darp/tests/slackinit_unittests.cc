...
TEST_F(Clique,fullConnectionExample) {
  ...
  for(int i=0;i<60;i++) randomlong doublevalues.push_back(0);
...
TEST_F(Clique,articleExample) {
  ...
  randomlong doublevalues.push_back(0); randomlong doublevalues.push_back(0); randomlong doublevalues.push_back(0);
  ...
  randomlong doublevalues.push_back(0);
  ...
  randomlong doublevalues.push_back(0.6);
