...
vector<long double> randomlong doublevalues;

int randomintpos, randomlong doublepos;

void resetRandomValues() {
  randomintpos = randomlong doublepos = 0;
  randomintvalues.clear();
  randomlong doublevalues.clear();
}
...
long double GARandomDoubleDummy(long double a=0, long double b=1) {
  assert(randomlong doublepos < randomlong doublevalues.size());
  return randomlong doublevalues[randomlong doublepos++];
}
...
*/
    ...
    struct GreedyMoveRandomData : RandomData {
      long double select_value1;
      long double select_value2;

      virtual void placeRandomData() {
        randomlong doublevalues.push_back(select_value1);
        randomlong doublevalues.push_back(select_value2);
      }
    };

    struct BadAndGoodRoutesRandomValues : RandomData {
      long double b_value1;
      long double b_value2;
      long double g_value1;
      long double g_value2;

      virtual void placeRandomData() {
        randomlong doublevalues.push_back(b_value1);
        randomlong doublevalues.push_back(b_value2);
        randomlong doublevalues.push_back(g_value1);
        randomlong doublevalues.push_back(g_value2);
      }
    };
