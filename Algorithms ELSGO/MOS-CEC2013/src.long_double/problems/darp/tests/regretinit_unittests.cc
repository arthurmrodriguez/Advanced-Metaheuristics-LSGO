...
TEST_F(AuxFunctionInitTest,decentralizationIndex) {
  ...
  long double sum1_2 = setCostsReq1Req2();
  long double sum1_3 = setCostsReq1Req3();
  long double sum2_1 = setCostsReq2Req1();
  long double sum2_3 = setCostsReq2Req3();
  long double sum3_1 = setCostsReq3Req1();
  long double sum3_2 = setCostsReq3Req2();
...
TEST_F(RegretInsertionTesting,scoreForInsertingRequestInRoute) {
  ...
  long double score = scoreForInsertingRequestInRoute(*gen,*req4,0,DARPObjFuncBasedInitC::BEST,pickins,delins);
...
TEST_F(RegretInsertionTesting,computeReqRegretValue) {
  ...
  long double regret_value1 = DARPRegretInsertionInitC::computeReqRegretValue(*gen,reqtmp1,ins_route1);
  long double regret_value2 = DARPRegretInsertionInitC::computeReqRegretValue(*gen,reqtmp2,ins_route2);
  ...
  long double regret_value3 = DARPRegretInsertionInitC::computeReqRegretValue(*gen,reqtmp3,ins_route2);
