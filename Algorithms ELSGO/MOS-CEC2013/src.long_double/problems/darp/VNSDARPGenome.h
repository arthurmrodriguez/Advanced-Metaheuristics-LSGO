...
private:
  long double minEvalWeightsUpdateValue_; // Min possible value for evalWeightsUpdateValue_
  long double maxEvalWeightsUpdateValue_; // Max possible value for evalWeightsUpdateValue_

public:

  VNSDARPGenome (unsigned x,
                 long double minevalweightsvalue, long double maxevalsweightsvalue,
