...
TwoDoubles f113(long double* x) {
    ...
    long double x1, Fadd, Fval, tmp, Fpen = 0., Ftrue = 0.;
    TwoDoubles res;
...
/*        for (i = 0; i < DIM; i++)
    ...
    Ftrue = 1. + 1. * tmp / (long double)(DIM - 1);
