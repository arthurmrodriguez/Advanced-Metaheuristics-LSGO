...
/* the return type of all benchmark functions: 2 long doubles, the true value and the noisy value - are equal in case of non-noisy functions */
struct twoDoubles {
long double Ftrue;
long double Fval;
};
...
typedef struct twoDoubles (*bbobFunction)(long double *);
...
/* Number of evaluations : long double to achieve larger precision */
long double num;
...
long double bestFnoisy;

/* value of vector x */
long double x[DIM_MAX];
