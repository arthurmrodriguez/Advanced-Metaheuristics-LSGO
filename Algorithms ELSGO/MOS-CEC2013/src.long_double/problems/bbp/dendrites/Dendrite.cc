...
static boost::normal_distribution<long double> NDInitialLength (13.058, 15.341);
static boost::normal_distribution<long double> NDInitialTort(0.91, 0.118);
static boost::variate_generator<boost::mt19937&, boost::normal_distribution<long double> > nDInitialLength(randgen, NDInitialLength);
static boost::variate_generator<boost::mt19937&, boost::normal_distribution<long double> > nDInitialTort(randgen, NDInitialTort);
...
/*	boost::mt19937 randgen (static_cast<unsigned int>(std::time(0)));
	boost::normal_distribution<long double> NDInitialLength (13.058, 15.341);
	//boost::normal_distribution<long double> NDInitialEucDist(11.149, 11.917);
	boost::normal_distribution<long double> NDInitialTort(0.91, 0.118);
	boost::variate_generator<boost::mt19937&, boost::normal_distribution<long double> > nDInitialLength(randgen, NDInitialLength);
	boost::variate_generator<boost::mt19937&, boost::normal_distribution<long double> > nDInitialTort(randgen, NDInitialTort);
	//_nDInitialLength = new boost::variate_generator<boost::mt19937&, boost::normal_distribution<long double> > (randgen, NDInitialLength);
	//_nDInitialTort = new boost::variate_generator<boost::mt19937&, boost::normal_distribution<long double> > (randgen, NDInitialTort);
*/
...
void Dendrite::grow(){
	...
	// datos de la raÃ­z
	boost::unordered_map<string, long double> data;
...
boost::unordered_map<string, long double> Dendrite::Metrics( void ){
	// Devuelve un map con los valores de cada una de las mÃ©tricas
	boost::unordered_map<string,long double> metrics;
	...
	metrics[str_numero_branches] = (long double)_numBranches;
...
long double Dendrite::predict(boost::unordered_map<string, long double>& data, string param){
...
void Dendrite::maxEucDist(long double dist){
	if( _maxEucDist < dist)
		_maxEucDist = dist;
}
...
void Dendrite::incrementLength(long double l){
	_totalLength += l;
}
