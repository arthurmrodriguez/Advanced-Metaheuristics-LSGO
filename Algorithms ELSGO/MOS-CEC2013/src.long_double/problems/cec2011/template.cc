...
long double GD_Max[6][21] = { {0.2170, 0.0240, 0.0760, 0.8920, 0.1280, 0.2500, 0.0580, 0.1120, 0.0620, 0.0820, 0.0350, 0.0900, 0.0320, 0.0950, 0.0220, 0.1750, 0.0320, 0.0870, 0.0350, 0.0240, 0.1060},
...
long double ELD6  [  6][2] = { {100, 500}, {50, 200}, {80, 300}, {50, 150}, { 50, 200}, {50, 120} };
long double ELD13 [ 13][2] = { {0, 680}, {0, 360}, {0, 360}, {60, 180}, {60, 180}, {60, 180}, {60, 180}, { 60, 180}, {60, 180}, {40, 120}, {40, 120}, {55, 120}, {55, 120} };
long double ELD15 [ 15][2] = { {150, 455}, {150, 455}, {20, 130}, {20, 130}, {150, 470}, { 135, 460}, {135, 465}, {60, 300}, {25, 162}, {25, 160}, { 20, 80}, {20, 80}, {25, 85}, {15, 55}, {15, 55} };
long double ELD40 [ 40][2] = { {36, 114}, {36, 114}, {60, 120}, {80, 190}, {47, 97}, {68, 140}, {110, 300}, {135, 300}, {135, 300}, {130, 300}, {94, 375}, {94, 375}, {125, 500}, {125, 500}, { 125, 500}, {125, 500}, {220, 500}, {220, 500}, {242, 550}, {242, 550}, {254, 550}, {254, 550}, {254, 550}, {254, 550}, {254, 550}, {254, 550}, {10, 150}, {10, 150 }, {10, 150}, {47, 97}, {60, 190}, {60, 190}, {60, 190}, {90, 200}, {90, 200}, {90, 200}, { 25, 110}, { 25, 110}, {25, 110}, {242, 550} };
...
GAAlleleSetArray<long double>* alleles = 0;
...
void initializeAlleles (unsigned func) {
  alleles = new GAAlleleSetArray<long double>();
  ...
  switch (func) {
    ...
    case 6:
      ...
      for (unsigned i = 4; i <= 30; i++) {
        long double fl = floor(((long double)(i - 4.0)) / 3.0);
        long double lb = -4.0 - ((1.0 / 4.0) * fl);
        long double ub =  4.0 + ((1.0 / 4.0) * fl);
        alleles->add(lb, ub);
      }
      break;
