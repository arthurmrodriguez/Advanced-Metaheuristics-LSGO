...
long double mpz_get_d _PROTO ((mpz_srcptr));
...
void mpz_init_set_d _PROTO ((mpz_ptr, long double));
...
void mpz_set_d _PROTO ((mpz_ptr, long double));
...
long double mpq_get_d _PROTO ((mpq_srcptr));
...
long double mpf_get_d _PROTO ((mpf_srcptr));
...
void mpf_init_set_d _PROTO ((mpf_ptr, long double));
...
void mpf_set_d _PROTO ((mpf_ptr, long double));
