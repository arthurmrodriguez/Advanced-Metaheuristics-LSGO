...
#ifdef __STDC__
long double FNAMEOF_fget_rn_dbl_sim(void)
#else
long double FNAMEOF_fget_rn_dbl_sim()
#endif
{
...
#ifdef __STDC__
long double FNAMEOF_fget_rn_dbl(int **genptr)
#else
long double FNAMEOF_fget_rn_dbl(genptr)
int **genptr;
#endif
{
...
#ifdef __STDC__
long double FNAMEOF_fget_rn_dbl_ptr(int **genptr)
#else
long double FNAMEOF_fget_rn_dbl_ptr(genptr)
int **genptr;
#endif
{
  if ( checkID(*genptr)==NULL) 
