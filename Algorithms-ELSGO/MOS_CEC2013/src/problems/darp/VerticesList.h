...
struct Vertex {
  ...
  static void setTimeConstants(bool relativeTime, long relativeDelayConstant, double maxRideValue, long delay);
  ...
  static long maxRideTime     (double distance);
