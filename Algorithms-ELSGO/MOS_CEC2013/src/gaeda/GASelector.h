...
public:
  ...
  GARouletteWheelSelector(int w=GASelectionScheme::SCALED) :  GASelectionScheme(w) { psum = (double*)0; n = 0;                  }
  GARouletteWheelSelector(const GARouletteWheelSelector& orig)                     { psum = (double*)0; n = 0; copy(orig);      }
  ...
  virtual void copy(const GASelectionScheme& orig) {
    ...
    n    = sel.n;
    psum = new double[n];
    memcpy(psum, sel.psum, n * sizeof(double));
  }
...
public:
  ...
  GASRSSelector(int w=GASelectionScheme::SCALED) : GASelectionScheme(w)
    { fraction = (double*)0; choices = (unsigned int *)0; n = 0; }
  GASRSSelector(const GASRSSelector& orig)
    { fraction = (double*)0; choices = (unsigned int *)0; n = 0; copy(orig); }
  ...
  virtual void copy(const GASelectionScheme& orig) {
    ...
    memcpy(fraction, sel.fraction, n * sizeof(double));
