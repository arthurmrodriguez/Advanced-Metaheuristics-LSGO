 ...
 */
double AverageFitnessQuality::averageFitness(const GAPopulation& pop, techIdType id, unsigned newInds) {

  unsigned nIndividualVector = 0;
  double   acumQualityVector = 0.0;
 ...
 */
double AverageFitnessIncrementQuality::averageFitnessIncrement(const GAPopulation& pop, techIdType id, unsigned newInds) {
...
//  assert(nIndividualVector == newInds);
  ...
  if (nIndividualVector > 0) {
    ...
    double q = acumQualityVector / newInds;
 ...
 */
double AverageDiversityQuality::averageDiversity(const GAPopulation& pop, techIdType id, unsigned newInds) {
 ...
 */
/*
double NSCQuality(const GAPopulation& pop, techIdType id, unsigned newInds) {
