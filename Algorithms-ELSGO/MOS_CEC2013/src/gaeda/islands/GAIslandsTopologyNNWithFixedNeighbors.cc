...
void GAIslandsTopologyNNWithFixedNeighbors::removeNeighborsUntilLimit(vector< vector<double> >& distance_matrix){
...
unsigned int GAIslandsTopologyNNWithFixedNeighbors::findFurthestNeighborMedoidPos(vector< vector<double> >& distance_matrix ){
