...
class MOSEAMultiDeme : public MOSEA {
 ...
 public:
  ...
  MOSEAMultiDeme(const std::vector<MOSGenome*>& genome, const double elitismPercent, const double minPart, const evolutionType evolutiveApproach = CentralEvolution);
