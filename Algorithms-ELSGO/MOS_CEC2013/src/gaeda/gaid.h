...
class GAID {
   ...
   public:
      ...
      enum {
            ...
            Algorithm = 0, BaseGA, SimpleGA, SteadyStateGA, IncrementalGA, SimpleEDA, MOS, MOS2, MOSRL, MOSMultiDeme, EAIslandsModel,
            ES, DistRoutingAlg,

            Population = 14,

            Scaling = 15,
            NoScaling, StandardScaling, LinearScaling, SigmaTruncationScaling, PowerLawScaling, Sharing,
            ...
            Bin2DecGenome, ListGenome, TreeGenome,
            ...
            Genealogy = 90,
            GenealogyTracer, GenealogyMemory,

            Technique = 100,
            TechniqueGA, TechniqueEDA, TechniqueDE, TechniqueES, TechniqueLS, TechniqueSTSDE, TechniqueNMA, TechniquePopLS, TechniqueCMAES, TechniqueLSObj, TechniqueAdapDE, TechniqueAdapSTSDE,

            Quality = 150,
            QualityFit, QualityFitInc, QualityDiv, QualityCompass, QualityNSC,

            Participation = 200,
            ConstantPF, DynamicPF
