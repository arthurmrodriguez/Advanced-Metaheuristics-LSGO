 ...
 * Constructors
 */
MOSEAMultiDeme::MOSEAMultiDeme (const std::vector<MOSGenome*>& genomes, const double elitismPercent, const double minPart, const evolutionType evolutiveApproach)
