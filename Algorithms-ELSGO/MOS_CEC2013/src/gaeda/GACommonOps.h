...
template <typename T> double ElementComparator (const GAGenome& a, const GAGenome& b) {
...
template <typename T> int ExponentialCrossover (const GAGenome& p1, const GAGenome& p2, GAGenome* c1, const double prob) {
...
template <typename T> int BinomialCrossover (const GAGenome& p1, const GAGenome& p2, GAGenome* c1, const double prob) {
   ...
   for(int j=0; j<dim; j++){
      ...
      double tmprand = GARandomDouble(0.0,1.0);
...
template <typename T> int SwapMutator (GAGenome& c, double pmut) {
...
template <typename T> int FlipMutator (GAGenome& c, double pmut) {
...
template <typename T> int RepeatedExchangeMutator (GAGenome& g, double pmut) {
...
template <typename T> int SimpleInversionMutator (GAGenome& g, double pmut) {
