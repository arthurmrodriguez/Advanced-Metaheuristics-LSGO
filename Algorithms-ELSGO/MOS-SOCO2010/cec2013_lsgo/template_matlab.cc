...
extern "C" GAGenome* defineProblem (int size, char *data) {
   ...
   sol = new long double[DIMS];

   initializeAlleles(XXX);
   GA1DArrayAlleleGenome<long double>* genome = new GA1DArrayAlleleGenome<long double> (DIMS, *alleles, objective);
...
void initializeAlleles (unsigned func) {
  switch (func) {
    ...
    case 14:
    case 15:
      alleles = new GAAlleleSet<long double>(-100.0, 100.0);
      break;

    case 2:
    case 5:
    case 9:
      alleles = new GAAlleleSet<long double>(-5.0, 5.0);
      break;

    case 3:
    case 6:
    case 10:
      alleles = new GAAlleleSet<long double>(-32.0, 32.0);
      break;
