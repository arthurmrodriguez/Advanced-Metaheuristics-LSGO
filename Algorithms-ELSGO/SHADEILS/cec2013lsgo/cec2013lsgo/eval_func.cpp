...
Benchmarks* generateFuncObj(int funcID,int dim, int noise);

void set_func(int funcID, int dim, bool noise) {
    bench = generateFuncObj(funcID,dim,noise);
    bench->nextRun();
}
