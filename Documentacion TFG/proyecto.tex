...
%\input{capitulos/02_EspecificacionRequisitos} %% estos dos pueden ser uno solo
%\input{capitulos/02_EspecificacionRequisitos} %% estos dos pueden ser uno solo
% Presupuesto: tareas y lo que voy a tardar y el precio por hora, HERCULES

%\input{capitulos/02bis_Planificacion}

%\input{capitulos/03_RevisionLiteratura} 	%revision literatura: los benchmarks

%\input{capitulos/04_AnalisisAlgoritmos}
%\input{capitulos/04bis_ImplementacionPseudocodigo}

%\input{capitulos/05_DisenioExperimental}

%\input{capitulos/06_PruebasYResultados} %parte experimental

%\input{capitulos/07_Conclusiones}

%%\chapter{capitulos/08_TrabajosFuturos}
